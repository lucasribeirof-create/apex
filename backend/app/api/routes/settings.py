...
@router.post("/ai")
def set_ai_settings(body: AISettingsBody):
    """Salva chave de um provedor e o ativa. Preserva chaves dos outros provedores."""
    if body.provider not in ("anthropic", "openai", "gemini"):
        raise HTTPException(status_code=400, detail="Provedor inválido. Use: anthropic, openai ou gemini")
